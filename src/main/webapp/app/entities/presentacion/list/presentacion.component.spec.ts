...
import { sampleWithRequiredData } from '../presentacion.test-samples';
...
describe('Presentacion Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.presentacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to presentacionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPresentacionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPresentacionIdentifier).toHaveBeenCalledWith(entity);
